package revend.configuration.security.auth;

import revend.configuration.security.token.AccessToken;
import revend.configuration.security.token.AccessTokenDecoder;
...
public class AuthenticationRequestFilter extends OncePerRequestFilter {
    ...
    AuthenticationRequestFilter(AccessTokenDecoder accessTokenDecoder) {
